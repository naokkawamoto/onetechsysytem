/**
 * 請負見積（quote-create）の「基本設定」タブの初期値を localStorage で上書きし、
 * マスタ管理から編集するためのユーティリティ。
 */
(function (global) {
    var STORAGE_KEY = 'mmUkeoiQuoteBasicDefaults_v1';
    ...
    global.QuoteUkeoiBasicDefaults = {
        ...
        UKEOI_BASIC_FIELD_META: UKEOI_BASIC_FIELD_META,
    };
